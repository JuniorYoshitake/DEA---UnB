...
Relatório para a disciplina Delineamento e Análise de Experimentos (Desbalanceado).
\end{minipage}
\end{flushright}
...
A coleta dos dados foi realizada de maneira padronizada, dado o roteiro:
