...
O teste de Shapiro-Wilk, sob $H_0: \text{os dados seguem distribuição Normal}$, indicou que os resíduos apresentam distribuição aproximadamente normal ($W = 0{,}96633$; $p-valor$ = 0,8241).
