...
dados_pipoca$prop_nao_estourou <- 
    dados_pipoca$Qtd_nao_estourou / dados_pipoca$Qtd_antes

medias_grupo <- aggregate(prop_nao_estourou ~ Grupo, data = dados_pipoca, 
                          mean)

desvio_grupo <- aggregate(prop_nao_estourou ~ Grupo, data = dados_pipoca, 
                          sd)
...
bc <- boxcox(modelo_inicial, plot = FALSE)
